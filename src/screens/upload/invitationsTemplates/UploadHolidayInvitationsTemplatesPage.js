...
class UploadHolidayInvitationsTemplatesPage extends Component {
    constructor(props) {
        super(props);
        ...
        this.state = {
            ...
            open: false,
            activeTabIndex: 0,
            imageCategory: 'invitationsTemplates',
            activeTab: 'christmas',
            mobileOpen: false,
        };
    }
            ...
            <div className={classes.root}>
                ...
                <div className={classes.appFrame}>
                    ...
                    <main className={classes.content}>
                        ...
                        <UploadTemplatePanel classes={classes} imageCategory={this.state.imageCategory}
...
UploadHolidayInvitationsTemplatesPage = withRoot(withStyles(uploadStyles)(UploadHolidayInvitationsTemplatesPage));
export default withAuthorization(authCondition)(UploadHolidayInvitationsTemplatesPage);
