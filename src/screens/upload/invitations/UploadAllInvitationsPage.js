...
class UploadAllInvitationsPage extends Component {
    constructor(props) {
        super(props);
    ...
    render() {
        ...
        let tabs = CategoryConfig.invitations.all;
                    ...
                    <AppBar className={classNames(classes.appBar, classes[`appBar-left`])}>
                        <Toolbar>
                            <Typography variant="title" color="inherit" noWrap>
                                Upload images of All Invitations
                            </Typography>
                        </Toolbar>
                    </AppBar>
                    <Hidden mdUp>
...
UploadAllInvitationsPage = withRoot(withStyles(uploadStyles)(UploadAllInvitationsPage));
export default withAuthorization(authCondition)(UploadAllInvitationsPage);
