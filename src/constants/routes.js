 ...
 * @type {string}
 */
export const UPLOADALLCARDS = '/upload-allCards';
...
export const UPLOADALLINVITATIONS = '/upload-allInvitations';
...
export const UPLOADHOLIDAYINVITATIONSTEMPLATES = '/upload-holidayInvitationsTemplates';
